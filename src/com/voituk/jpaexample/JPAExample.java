 ...
 * + 'ексклюзивная блокировка' (eXclusive) - блокировка уровня записи позволяет транзакции: читать, обновлять, удалять строку. Используется для операций изменения данных (UPDATE, DELETE);
 *                                         - позволяет блокировать строку: на чтение и на запись;
 *                                         - запрещает другим транзакциям блокировать строку;
 * --------------------------------------------------------------------------------------------------------------------------------------------------------------
 * + 'коллективная блокировка' (Shared) - разрешает паралельно установливать другие Shared-блокировки на теже строки;
 ...
 * + 'ексклюзивная блокировка' (eXclusive) - данная блокировка не может быть установлена, если существуют какие-либо другие блокировки на ресурсе, т.е. команда будет ждать снятия всех существующих блокировок;
 ...
 * Если блоки 'try/catch' будут вложени их будет много - тогда исключение перейдет к внешнему блоку 'catch'
 * *********************************
