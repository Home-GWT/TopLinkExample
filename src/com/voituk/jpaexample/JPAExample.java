 ...
 *    --------------------------
 *    Рефлексивность: сравнение объекта самого-себя - всегда равны (при условии что объекты неNULL)
 *    Симметричность: если два объкекты 'A' и 'B' равны - тогда при обратном условии сравнения (либо 'A==B' либо 'B==A') тоже гарантируется их равенство
 *    Транзитивность: три объекта 'A','B','C'; при двух условии равенства объектов если 'A==B' и 'B==C' - тогда тоже гарантируется равенство между 'A==C'
 *    ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ? ?
 *    (Время против памяти на примере хеш-таблиц на Java) http://habrahabr.ru/post/230283/
