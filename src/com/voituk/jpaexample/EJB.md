...
+ + + + + + + + + + + + + + + + + + [ . ]
1. Добавить пользователя у которого будет право на просмотр скрытой информации (это в настройках сервера приложений, например: для сервера приложений 'Tomcat' это можно сделать в 'conf/tomcat-users.xml')
     <role rolename="admin"/>
