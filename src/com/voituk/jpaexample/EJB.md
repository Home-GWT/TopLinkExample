...
3. Передача-обмен сообщениями (Java Message Driven)
   ...
   - На 'клиентской стороне' стоит (клиентская) виртуальная Java-машина, AJAX через JVM (асинхронные Java...XML...объекты) обращается к Операционной Системе и через которую выполняются клиентские обращения к серверу...
   ...
   - На 'серверной стороне' стоит (серверная) виртуальная Java-машина, которая обращается к Операционной Системе и через которую выполняются серверные обращения к клиентам...
