...
При передаче объекта по HTTP-протоколу - в действительности же передается только файл (разбитый на пакеты...с сохраненным состоянием объекта) который может востанавливаться на разных JVM...
...
> Обмен данными между разными приложениями внутри одного компютера выполняется с помощью 'слота':
...
- с одной стороны работают приложения. Некоторые приложения (при необходимости) могут работать со слотами, а другие приложения могут работать быть без слотов...
- с другой стороны есть (физические) устройства, это контроллеры куда могут быть подключены клавиатура, мышка для генерации команды
 - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
