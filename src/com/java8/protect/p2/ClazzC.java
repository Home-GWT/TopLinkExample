...
////        a.privateFunc();
    ...
    public void testC(){
//        func();            // За пределами пакета доступ к дефолтному методу в классе-наследника будет Закрыт
        protectedFunc();   // За пределами пакета доступ к защищенному методу классе-наследника будет Открыт
//        privateFunc();
    }
