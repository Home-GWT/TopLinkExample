...
////        a.privateFunc();
    ...
    public void testC(){
//        func();            // За пределами пакета доступ к дефолтному методу внутри классе-наследника будет Закрыт
        protectedFunc();   // За пределами пакета доступ к защищенному методу внутри классе-наследника будет Открыт
//        privateFunc();
    }
