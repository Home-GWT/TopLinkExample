...
|     | Атрибут        | Вызов вне транзакции         | Вызов уже в транзакции |
| --- | -------------- | ---------------------------- | ---------------------- |
| 1.  | `Required`     | Начнется новая               | Будет использовать     |
| 2.  | `RequiresNew`  | Начнется новая               | Всегда новая           |
| 3.  | `Mandatory`    | TransactionRequiredException | Будет использовать     |
| 4.  | `NotSupported` | Выполнение вне контекста транзацкии                   |
| 5.  | `Supports`     | Не запустить транзакцию      | Будет использовать     |
| 6.  | `Never`        | Не запустить транзакцию      | RemoteException        |
