...
|     | Атрибут        | Вызов вне транзакции         | Вызов уже в транзакции | Описание                                                                                                                    |
| --- | -------------- | ---------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| 1.  | `Required`     | Начнется новая               | Будет использовать     | (Являющийся атрибутом по умолчанию в EJB 3.0 и Spring)                                                                      |
